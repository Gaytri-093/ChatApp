...
const Signup = () => {
  ...
  return (
    <>
      <div className="bg-slate-800 h-screen text-gray-300 flex items-center justify-center">
        <form 
        ...
        className=" border border-white px-6 py-2 rounded-md space-y-3 w-96">
          ...
          <h2 className="text-xl font-bold text-white">SignUp</h2> <br />
          {/* username */}
          <label className="input input-bordered flex items-center gap-2 border-gray-400 bg-slate-800">
            <svg
          ...
          <div className="flex justify-between">
            <p>Have an account? <Link className="text-blue-500 underline cursor-pointer ml-1" to={"/login"}>Login</Link></p>
            <input type="submit" value="SignUp" className="text-white bg-green-500 px-3 py-1 cursor-pointer rounded-lg" />
          </div>
        </form>
      </div>
    </>
